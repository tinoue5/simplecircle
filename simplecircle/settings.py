"""
Django settings for simplecircle project.
...
MIDDLEWARE = [
    ...
    'simplecircle.middleware.AppMiddleware',
]

ROOT_URLCONF = 'simplecircle.urls'
...
WSGI_APPLICATION = 'simplecircle.wsgi.application'
